...
//           .append("svg:circle").classed("polygon-vertices g" + group.group, true)
...
//       vis.vertices
//         .data(data).enter()
//         .append("svg:polygon") //.classed(function(d) { return "polygon-areas " + d.group }, true)
//         .attr("class", function(d) { return "polygon-areas g" + d.group })
